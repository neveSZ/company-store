...
feature 'collaborator can see all products from his company' do
  ...
  scenario 'no product from his company' do
    ...
    collaborator_main = Collaborator.create!(email: 'victor@treinadev.com.br', password: '!a123456789b', full_name: 'Victor Neves Silva', birth_date: '13/07/2000', role: 'Analista', department: 'Tecnologia')
    collaborator_secundary = Collaborator.create!(email: 'victor@empresa.com.br', password: '!a123456789b', full_name: 'Victor Neves Silva', birth_date: '13/07/2000', role: 'Analista', department: 'Tecnologia')
    Product.create!(name: 'S20', category: category, description: 'teste teste', value: 10.00, status: 0, collaborator: collaborator_secundary)
    Product.create!(name: 'S30', category: category, description: 'teste teste', value: 100.00, status: 0, collaborator: collaborator_secundary)
    Product.create!(name: 'S40', category: category, description: 'teste teste', value: 200.00, status: 1, collaborator: collaborator_secundary)
    Product.create!(name: 'S50', category: category, description: 'teste teste', value: 300.00, status: 2, collaborator: collaborator_secundary)
    Product.create!(name: 'S60', category: category, description: 'teste teste', value: 400.00, status: 3, collaborator: collaborator_secundary)
    Product.create!(name: 'S70', category: category, description: 'teste teste', value: 400.00, status: 0, collaborator: collaborator_secundary)
